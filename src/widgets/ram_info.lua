...
return function()
          ...
          {
            {
              ...
              image = gears.color.recolor_image(icon_dir .. "ram.svg", color["Red200"]),
              resize = false
            },
            id = "icon_layout",
  ...
  Hover_signal(ram_widget, '#1e1e1edd', color["Red200"])
  ...
  ram_widget:connect_signal(
    "button::press",
    function()
      awful.spawn('lxterminal -e htop')
    end
  )
