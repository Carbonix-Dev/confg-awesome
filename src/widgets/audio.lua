...
return function(s)
    ...
    awful.spawn.easy_async_with_shell(
      ...
      function(stdout)
        ...
        audio_widget.container.audio_layout.icon_margin.icon_layout.icon:set_image(
          gears.color.recolor_image(icon .. ".svg", color["Blue200"]))
    ...
    awful.spawn.easy_async_with_shell(
      ...
      function(stdout)
        if stdout:match("yes") then
          ...
          audio_widget.container.audio_layout.icon_margin.icon_layout.icon:set_image(
            gears.color.recolor_image(icondir .. "volume-mute" .. ".svg", color["Blue200"]))
  ...
  -- Signals
  Hover_signal(audio_widget, '#1e1e1edd', color["Blue200"])
