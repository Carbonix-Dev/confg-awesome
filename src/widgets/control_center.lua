...
return function(s)
  ...
  local ctrl_center = wibox.widget {
    {
      {
        {
          {
  ...
  -- Signals
  Hover_signal(ctrl_center, color["Blue200"], color["Grey900"])

  ctrl_center:connect_signal(
    "button::press",
    function()
      -- awful.spawn('pavucontrol')
      -- awesome.emit_signal("module::slider:update")
      awesome.emit_signal("widget::control_center:rerun")
