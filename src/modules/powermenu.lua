...
return function(s)
  ...
  local profile_picture = wibox.widget {
    image = awful.util.getdir("config") .. "src/assets/pfp.png",
    resize = true,
  ...
  local update_profile_picture = function()
      profile_picture:set_image(awful.util.getdir("config") .. "src/assets/pfp.png")
  end
  ...
  local reboot_command = function()
    awful.spawn("poweroff --reboot")
    awesome.emit_signal("module::powermenu:hide")
  end
  
  local reload_awesome_command = function()
    awful.spawn([[ killall onedrive_tray ]])
    awful.spawn("bash -c \"echo 'awesome.restart()' | awesome-client\"")
    awesome.emit_signal("module::powermenu:hide")
  end
  ...
  local reload_button = button("Reload", icondir .. "reboot.svg", color["Pink100"], reload_awesome_command)
  ...
  Hover_signal(reload_button.background, color["Pink100"], color["Grey900"])
