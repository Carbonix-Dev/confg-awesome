...
return function(s)
  ...
  local hide_control_center = gears.timer {
    timeout = 2,
    autostart = true,
    callback = function()
  ...
  control_center:connect_signal(
    ...
    function()
      control_center.visible = true
      hide_control_center:again()
  end
  )

  awesome.connect_signal(
    "widget::control_center:rerun",
    function()
    if hide_control_center.started then
      hide_control_center:again()
    else
      hide_control_center:start()
    end
  end
  )
end
