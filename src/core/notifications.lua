...
naughty.config.defaults.icon_size = dpi(15)
...
naughty.connect_signal(
  ...
  function(n)
    if n.urgency == "critical" then
      n.title = string.format("<span foreground='%s' font='JetBrainsMono Nerd Font, ExtraBold 12'>%s</span>",
      ...
      n.bg = color["Grey900"] .. '75'
      n.timeout = n.timeout or nil
    else
      n.title = string.format("<span foreground='%s' font='JetBrainsMono Nerd Font, ExtraBold 12'>%s</span>",
        color["Pink200"], n.title) or ""
      n.message = string.format("<span foreground='%s'>%s</span>", "#ffffffaa", n.message) or ""
      n.bg = color["Grey900"] .. '7'
      n.timeout = n.timeout or naughty.config.defaults.timeout
    end
